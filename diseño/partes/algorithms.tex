...
\paragraph{Estimación y Función de Costo.}
...
\centering
\subfloat[][]{
   \includegraphics[width=48mm]{minusLogX}
 }
\subfloat[][]{
   \includegraphics[width=37mm]{minusLog1minusX}
 }
